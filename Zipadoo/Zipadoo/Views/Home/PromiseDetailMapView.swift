...
struct PromiseDetailMapView: View {
    ...
    var body: some View {
        ...
        .task { // 초기화 코드
            // myLocation 초기화
            let departureLatitude = 37.48479761304374
            let departureLongitude = 127.01740096547181
            ...
            do {
                try await locationStore.fetchData(locationIdArray: promise.locationIdArray)
//                try await locationStore.updateDeparture(newLatitude: departureLatitude, newLongtitude: departureLongitude)
                print("파베 패치 완료")
